        ...
        <section className="relative py-16 sm:py-24 bg-gray-900 overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {/* Mission Card */}
                    <div className="bg-white p-6 sm:p-10 rounded-3xl text-center group hover:-translate-y-2 transition-transform duration-300 shadow-xl">
                        <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-white border-4 border-green-500 flex items-center justify-center p-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    ...
                    {/* Vision Card */}
                    <div className="bg-white p-6 sm:p-10 rounded-3xl text-center group hover:-translate-y-2 transition-transform duration-300">
