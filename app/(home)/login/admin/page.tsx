              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-gray-50/50 border border-transparent rounded-[20px] pl-6 pr-14 py-4 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-600/5 focus:bg-white focus:border-purple-600/10 transition-all duration-300"
                    placeholder="••••••••••••"
                    required
                  />
                  <button
