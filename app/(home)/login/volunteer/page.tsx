          ...
          <div className="bg-white/80 backdrop-blur-3xl border border-white/60 rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] p-8 md:p-14 relative overflow-hidden group">
            ...
            <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-gray-50/50 border border-transparent rounded-[20px] pl-6 pr-14 py-4 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-emerald-600/5 focus:bg-white focus:border-emerald-600/10 transition-all duration-300"
                    placeholder="••••••••••••"
                    required
                  />
                  <button
                    ...
                    className="absolute right-5 top-1/2 -translate-y-1/2 z-10 text-gray-400 hover:text-emerald-600 transition-colors cursor-pointer"
                  >
                    {showPassword ? (
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center bg-gray-100 border border-gray-200 rounded-[20px] px-6 py-4 font-black text-lg text-emerald-700 tracking-wider select-none min-w-[120px] text-center">
                  ...
                  <input
                    ...
                    className="flex-1 bg-gray-50/50 border border-transparent rounded-[20px] px-6 py-4 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-emerald-600/5 focus:bg-white focus:border-emerald-600/10 transition-all duration-300 font-bold"
                    placeholder="Answer"
                    required
                  />
                </div>
