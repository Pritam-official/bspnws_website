                ...
                <div className="flex-1 w-full max-w-[480px]">
                    <div className="bg-white/80 backdrop-blur-3xl border border-white/60 rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] p-8 md:p-14 relative overflow-hidden group">
                        ...
                        <form onSubmit={handleSubmit} className="relative z-10 space-y-5">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-black text-gray-500 uppercase tracking-widest ml-1">Registered Phone Number</label>
                                <div className="relative">
                                    <input
                                        type="tel"
                                        name="phone"
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-black text-gray-500 uppercase tracking-widest ml-1">Registered Email Address</label>
                                <div className="relative">
                                    <input
                                        type="email"
                                        name="email"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-gray-50/50 border border-transparent rounded-[20px] pl-6 pr-14 py-4 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-emerald-600/5 focus:bg-white focus:border-emerald-600/10 transition-all duration-300"
                                        placeholder="••••••••••••"
                                        required
                                    />
                                    <button
