...
export default function UpcomingProgrammesPage() {
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="relative pt-24 sm:pt-32 pb-16 bg-gradient-to-br from-emerald-950 via-[#0d1f17] to-emerald-950 text-white overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 max-w-5xl">
                    <p className="text-emerald-400 text-xs font-black uppercase tracking-[0.2em] mb-3">BSPNWS · Future Endeavours</p>
                    <h1 
                    ...
                    <p className="text-emerald-200/60 max-w-2xl text-sm sm:text-base font-medium">
                        Join our mission! Preview our planned community programs, healthcare consultation grids, tree plantation rallies, and nutrition drives.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 py-16 max-w-5xl">
                {loading ? (
                    ...
                    <div className="bg-white rounded-3xl p-16 text-center border border-slate-100 shadow-xl max-w-2xl mx-auto">
                        ...
                        <h2 className="text-xl font-black text-slate-800 uppercase tracking-wider mb-2">No Scheduled Events</h2>
                        <p className="text-slate-400 text-sm">We are planning some amazing social programs. Join us on social media for upcoming schedule releases!</p>
                    </div>
                ) : (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-1 space-y-4">
                                    ...
                                    <div className="pt-4 border-t border-slate-50 mt-auto flex items-center justify-between text-xs font-black uppercase tracking-wider text-emerald-600 group-hover:text-emerald-500 transition-colors">
                                        <span className="flex items-center gap-1"><Heart className="w-3.5 h-3.5 fill-current" /> Volunteer Details</span>
