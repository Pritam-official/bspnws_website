...
export default function BoardOfDirectorsAdminPage() {
    ...
    return (
        <div className="relative">
            ...
            {/* Page Header */}
            <div className="mb-8">
                <h1 className="text-2xl font-black text-gray-900 tracking-tight">Board of Directors</h1>
                <p className="text-sm text-gray-400 font-bold mt-1">Manage governing board members</p>
            </div>
            ...
            <div className="bg-white rounded-2xl border-2 border-gray-100 p-6 mb-8 shadow-sm">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Date Joined (Optional)</label>
                        <input
                            type="text"
                            name="date"
                            value={formData.date}
                            onChange={handleChange}
                            placeholder="e.g. June 2000"
                            className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 transition-all shadow-sm"
                        />
                    </div>
                    <div className="space-y-1.5">
            ...
            <div className="bg-white rounded-2xl border-2 border-gray-100 overflow-hidden shadow-sm">
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h2 className="text-sm font-black text-gray-900 uppercase tracking-widest">Active Governing Board</h2>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        <tbody>
                            ...
                            {members.map((m) => (
                                <tr key={m._id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors group">
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            <div className="relative">
                                                {m.image ? (
                                                    <img src={m.image} alt={m.name} className="w-12 h-12 rounded-full border-2 border-white shadow-md object-cover ring-4 ring-gray-50 group-hover:ring-pink-50 transition-all" />
                                                ) : (
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-sm font-bold text-gray-900 group-hover:text-pink-600 transition-colors">{m.name}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
